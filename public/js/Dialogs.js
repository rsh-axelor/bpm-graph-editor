...
//   mxUtils.write(h3, mxResources.get("about") + " GraphEditor");
  ...
  img.setAttribute("src", "https://www.axelor.com/wp-content/uploads/2019/09/logo_axelor01.svg");
  div.appendChild(img);
  mxUtils.br(div);
//   mxUtils.write(div, "Powered by mxGraph " + mxClient.VERSION);
//   mxUtils.br(div);
  var link = document.createElement("a");
  link.setAttribute("href", "https://www.axelor.com/");
  link.setAttribute("target", "_blank");
  mxUtils.write(link, "https://www.axelor.com");
...
ExportDialog.exportFile = function (editorUi, name, format, bg, s, b, dpi) {
  ...
  if (format === "xml") {
    ...
    dl.setAttribute(
      "href",
      "data:Application/octet-stream;utf-8," + encodedData
    );
